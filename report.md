...
Repository URL: [https://github.com/jakebutler22/Expedia-lite](https://github.com/jakebutler22/Expedia-lite/tree/part2-submission)

Repository snapshot: [github.com/jakebutler22/Expedia-lite at the submitted checkpoint](https://github.com/jakebutler22/Expedia-lite/tree/part2-submission)

Submitted Part 2 checkpoint: this commit (`Complete Part 2 verification hardening and report`). Its exact hash is recorded in the immediately following documentation commit on `main`, and the annotated Git tag `part2-submission` points to this checkpoint. The Part 1 checkpoint remains intact at `77d101ad62bedad9d7dd82fd03b7cf242fbdb17c` under annotated tag `part1-submission`.
